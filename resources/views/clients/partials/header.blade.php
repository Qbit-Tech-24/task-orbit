                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                        ...
                        <span class="profile-username">
                            ...
                            <span class="fw-bold">{{ Auth::guard('clinetuser')->user()->name }}</span>
                        </span>
                    </a>
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    ...
                                    <div class="u-text">
                                        <h4>{{ Auth::guard('clinetuser')->user()->name }}</h4>
                                        <p class="text-muted">{{ Auth::guard('clinetuser')->user()->email }}</p>
                            ...
                            <li>
                                ...
                                <div class="dropdown-divider"></div>
                                <form method="GET" action="{{ route('client.logout') }}" class="m-0 p-0">
                                    @csrf
