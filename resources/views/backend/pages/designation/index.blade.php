                                    ...
                                    <div class="card-body">
                                        <form class="row g-3" action="{{ route('designation.store') }}" method="POST">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('designation_shortname') is-invalid @enderror"
                                                    placeholder="Designation Short Name" name="designation_shortname">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('designation_code') is-invalid @enderror"
