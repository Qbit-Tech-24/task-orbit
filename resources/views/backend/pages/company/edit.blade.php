                                        ...
                                        <form class="row g-3" action="{{ route('companies.update',$company->id) }}" method="POST"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea class="form-control @error('company_address') is-invalid @enderror" name="company_address" rows="4"
                                                    cols="4">{{ $company->company_address ?? '' }}</textarea>
                                            ...
                                            <div class="col-12">
                                                ...
                                                name="contact_no" value="{{ $company->contact_no ?? '' }}" />
                                                @error('contact_no')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control @error('whatsapp_number') is-invalid @enderror"
                                                    name="whatsapp_number" value="{{ $company->whatsapp_number ?? '' }}"/>
                                            ...
                                            <div class="col-12">
                                                ...
                                                name="land_phone_no" value="{{ $company->land_phone_no ?? '' }}" />
                                                @error('land_phone_no')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                name="company_website" value="{{ $company->company_website ?? '' }}" />
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="facebook_url"  value="{{ $company->facebook_url ?? '' }}" />
                                                @error('facebook_url')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                name="registration_no" value="{{ $company->registration_no ?? '' }}" />
